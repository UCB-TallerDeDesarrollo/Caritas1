    ...
    module Validation
      ...
      private
        def ensure_authentication_attempted
          errors.add(:base, I18n.t('error_messages.no_authentication_details', :default => "Usted no proporsiono ninguna informacion para iniciar la sesion.")) if errors.empty? && attempted_record.nil?
        end
    end
  end
end
