    ...
    module Login
      ...
      module Config
        ...
        def validates_format_of_login_field_options(value = nil)
          rw_config(:validates_format_of_login_field_options, value, {:with => Authlogic::Regex.login, :message => I18n.t('error_messages.login_invalid', :default => "deberia tener solo letras, numeros, espacio, y .-_@ por favor.")})
        end
