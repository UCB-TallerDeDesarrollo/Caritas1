...
ActiveRecord::Schema.define(:version => 20121129043311) do
  ...
  create_table "social_cards", :force => true do |t|
    ...
    t.string   "social_card_photo_file_name"
    t.string   "social_card_photo_content_type"
    t.integer  "social_card_photo_file_size"
    t.datetime "social_card_photo_updated_at"
  end
  ...
  create_table "volunteers", :force => true do |t|
    ...
    t.string   "phone_number"
    t.string   "movil"
    t.string   "volunteer_photo_file_name"
    t.string   "volunteer_photo_content_type"
    t.integer  "volunteer_photo_file_size"
    t.datetime "volunteer_photo_updated_at"
    t.integer  "state_inactive"
  end
